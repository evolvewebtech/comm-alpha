...
<link rel="stylesheet" type="text/css" href="../jquerymobile_old/css/jquery.mobile-1.0.1.min.css"/>
...
//                );
    ...
    <form id="ricerca-ordine-form" method="get" action="" style="display:none;background-color:white;">
        <fieldset>
            ...
            <label style="margin-right: 87px;" class="" for="ricerca_ordine">numero ordine</label>
