...
<style type="text/css">
    /*Demo Styles*/
    body{ background:#e9e8e4 url('../media/img/bg-black.png'); }
     ...
     <div class="accordion">
        <div id="amministrazione" class="admin-page">
            <div class="mosaic-block fade">
                ...
                <div style="background-color:#fff" class="mosaic-backdrop">
                    <img alt="ristorante" src="../media/img/restaurant.png"/>
                </div>
            </div>
            ...
            <div class="mosaic-block bar3">
                ...
                <div style="background-color:#fff" class="mosaic-backdrop">
                    <img style="padding:60px"src="../media/img/ticket.png"/>
                </div>
            </div>
            ...
            <div class="mosaic-block cover2">
                <div style="background-color:#fff" class="mosaic-overlay"><img src="../media/img/stat.png"/></div>
        ...
        <div id="alimento" class="admin-page">
            <div class="mosaic-block fade">
                ...
                <div style="background-color:#fff" class="mosaic-backdrop">
                    <img alt="ristorante" src="../media/img/undo.png"/>
                </div>
            </div>
            <div class="mosaic-block fade">
                ...
                <div style="background-color:#fff" class="mosaic-backdrop">
                    <img alt="ristorante" src="../media/img/categories.png"/>
                </div>
            </div>
            <div class="mosaic-block fade">
                ...
                <div style="background-color:#fff" class="mosaic-backdrop">
                    <img alt="ristorante" src="../media/img/beef.png"/>
                </div>
            </div>
            <div class="mosaic-block fade">
                ...
                <div style="background-color:#fff" class="mosaic-backdrop">
                    <img alt="ristorante" src="../media/img/add.png"/>
                </div>
            </div>
            <!--Bar 3-->
            <div class="mosaic-block bar3">
                ...
                <div style="background-color:#fff" class="mosaic-backdrop">
                    <img style="padding:60px"src="../media/img/menu.png"/>
                </div>
            </div>
