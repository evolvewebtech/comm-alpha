...
// for use: http://www.dyn-web.com/code/table_class/

/**
 *
 * The HTML_Table class is a basic PHP class for generating html tables.
 * It is useful for separating logic from markup and keeping code cleaner
 * when outputing mysql query results or displaying elements of arrays.
 *
 */
class HTML_Table {
