<?php
    try {
        ...
        $firstUpdate = mysql_real_escape_string($_POST['firstUpdate']);
        ...
        if($objSession->IsLoggedIn()){
            ...
            if(get_class($user) == 'Cassiere') {
                ...
                //Verifica se database alimenti aggiornato o se 1° caricamento pagina
                if ((!DataManager2::getMenuAggiornato($cassiere_id)) || ($firstUpdate == 'true')) {
                    ...
                    //Memorizzazione che l'elenco degli alimenti è stato inviato al client
                    $arr['aggiornato'] = false;
                    DataManager2::aggiornaMenuAggiornato($cassiere_id, 1);
                    
                } //Fine verifica se database aggiornato
